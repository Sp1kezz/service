...
public class ProduceService {
    ...
    public void sendOneWayMessage(String topic, String tag) {
        ...
        this.payload = new Order(1,"O01", "U01", "P01", 2, false, new Date());
    ...
    public void sendOrderedMessages(String topic, String tag) {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            rocketMQTemplate.syncSendOrderly(this.destination, new Order(i,"O0" + i, "U01", "P01", 2, false, new Date()), "hashKey");
        }
    }
    ...
    public void sendBatchMessages(String topic, String tag) {
        ...
        for (int i = 0; i < 10; i++) {
            this.payload = new Order(i,"O0" + i, "U01", "P01", 2, false, new Date());
